...
export class Backend implements backendInterface {
    ...
    async addExam(arg0: string, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addExam(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async createFlashcard(arg0: string, arg1: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createFlashcard(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDailyTimetable(): Promise<Array<Subject>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyTimetable();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDaysUntilExam(arg0: bigint): Promise<bigint | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDaysUntilExam(arg0);
    ...
    async getFlashcard(arg0: bigint): Promise<Flashcard> {
        if (this.processError) {
            try {
    ...
    async updateFlashcard(arg0: bigint, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFlashcard(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
